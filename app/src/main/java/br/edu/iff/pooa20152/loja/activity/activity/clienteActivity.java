package br.edu.iff.pooa20152.loja.activity.activity;
...
import br.edu.iff.pooa20152.loja.R;
import br.edu.iff.pooa20152.loja.activity.domain.Cliente;
import br.edu.iff.pooa20152.loja.activity.domain.ClienteService;
import br.edu.iff.pooa20152.loja.activity.helper.RestFullHelper;
...
public class clienteActivity extends AppCompatActivity {
    ...
    public class ClienteTask extends AsyncTask<String, String, Cliente> {
        ...
        protected void onPreExecute() {
            dialog = new ProgressDialog(clienteActivity.this);
            dialog.show();
        }
